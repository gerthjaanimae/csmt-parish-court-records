...
mkdir -p $script_dir/../translated-ngrams/$1
$script_dir/translate-ngrams.sh $script_dir/../records-xml/$1 $script_dir/../translated-ngrams/$1 ~/moses/vallakohtud/experiments/$1/mert-1/moses.ini
}
...
python $script_dir/annotate_corpus.py $script_dir/../translated-ngrams $script_dir/../analyses-translated
