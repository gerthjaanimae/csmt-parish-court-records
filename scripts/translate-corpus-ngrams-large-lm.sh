...
mkdir -p $script_dir/../translated-ngrams-large-lm/$1
$script_dir/translate-ngrams.sh $script_dir/../records-xml/$1 $script_dir/../translated-ngrams-large-lm/$1 ~/moses/vallakohtud/experiments/$1/mert-1/moses.ini
}

#Create or initialize the training, dev and test set
python $script_dir/prepare-corpus-moses-ngrams.py $records_annotated $train_files
...
python $script_dir/annotate_corpus.py $script_dir/../translated-ngrams-large-lm $script_dir/../analyses-translated
