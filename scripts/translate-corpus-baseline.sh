...
mkdir -p $script_dir/../translated-baseline/$1
$script_dir/translate.sh $script_dir/../records-xml/$1 $script_dir/../translated-baseline/$1 ~/moses/vallakohtud/experiments/$1/mert-1/moses.ini
}
...
python $script_dir/annotate_corpus.py $script_dir/../translated-baseline $script_dir/../analyses-translated
